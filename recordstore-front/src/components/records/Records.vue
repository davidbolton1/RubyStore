...
<div class="max-w-md m-auto py-10">
  ...
  <form @submit.prevent="addRecord">
    <div class="mb-6">
      ...
      <input type="text" id="record_title" class="input" autofocus autocomplete="off" placeholder="Type a record name" v-model="newRecord.title">
    </div>

    <div class="mb-6">
      <label for="record_year" class="label">Year</label>
      <input type="text" id="record_year" class="input" autofocus autocomplete="off" placeholder="Year" v-model="newRecord.year">
    </div>
    ...
    <div class="mb-6">
      ...
      <p class="pt-4">Don't see an artist? <router-link to="/artists" class="link-grey">Create one</router-link>
      </p>
    </div>
